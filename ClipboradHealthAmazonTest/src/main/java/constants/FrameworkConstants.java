...
public class FrameworkConstants {
    ...
    private static final int LONGWAITTIMEINSECONDS = 20;
    ...
    private static final String SELENIUMGRIDURL="http://" +((System.getProperty("HUB_HOST") != null)?System.getProperty("HUB_HOST"):"localhost")+ ":4444/wd/hub";
    ...
    public static int getLongwaittimeinseconds() {
		return LONGWAITTIMEINSECONDS;
	}
